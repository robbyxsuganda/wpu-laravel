...
@if (Session::has('success'))
    <div class="flex justify-end">
        <div id="toast-success" class="flex absolute top-40 items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-xxl font-semibold pl-4 mb-4">Post By: {{ Auth::user()->name }}</h2>
                ...
                <div class="w-full md:w-1/2">
                    <form class="flex items-center" action="" method="GET">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" name="keywoard" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search Post" >
                        </div>
                    </form>
                </div>
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="post-{{ $post->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="post-{{ $post->id }}-dropdown-button">
                                            ...
                                            <li>
                                                <a href="/dashboard/{{ $post->slug }}/edit" data-modal-target="updateProductModal" data-modal-toggle="updateProductModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
